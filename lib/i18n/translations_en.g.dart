...
class TranslationsTasksEn {
	...
	// Translations
	late final TranslationsTasksListEn list = TranslationsTasksListEn.internal(_root);
	late final TranslationsTasksTaskEn task = TranslationsTasksTaskEn.internal(_root);
}
...
class TranslationsTasksListEn {
	TranslationsTasksListEn.internal(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String get title => 'My Tasks';
	String get empty_state => 'No tasks yet. Create your first task!';
	String get loading => 'Loading tasks...';
}

// Path: tasks.task
class TranslationsTasksTaskEn {
	TranslationsTasksTaskEn.internal(this._root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'tasks.list.title': return 'My Tasks';
			case 'tasks.list.empty_state': return 'No tasks yet. Create your first task!';
			case 'tasks.list.loading': return 'Loading tasks...';
			case 'tasks.task.complete': return 'Complete';
			case 'tasks.task.incomplete': return 'Incomplete';
